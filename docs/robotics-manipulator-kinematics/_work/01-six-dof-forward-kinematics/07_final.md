---
title: 6자유도 매니퓰레이터의 순기구학 기준 원고 확정
status: final
owner: agent
updated: 2026-09-22
target_reader: 1~2단계를 마친 로보틱스 입문자
topic: 6R 직렬 팔의 변환 체인과 표준 DH 표
---
...
- 챕터 본문: `docs/robotics-manipulator-kinematics/01-six-dof-forward-kinematics.md`
- 책 진입점: `docs/robotics-manipulator-kinematics/index.md`
- 챕터 자산: `docs/robotics-manipulator-kinematics/assets/six-dof-forward-kinematics/`
