...
이 디렉터리는 2026-08-19의 공식 LazyVim Starter를 바탕으로 다음 extras를 추가한
완성 예제다.
...
Rust의 `rust-analyzer`와 `rustfmt`, C++ compiler와 CMake, 각 프로젝트의 runtime과
dependency는 Mason이 아니라 각 language toolchain과 프로젝트가 관리한다.
