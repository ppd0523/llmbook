...
- [Nix 첫걸음: NixOS·개발 셸·Home Manager를 위한 기초](./nix-foundation/index.md)
...
- [로보틱스 기구학 기초](./robotics-kinematics-foundations/index.md)
- [매니퓰레이터 순기구학과 수치 역기구학](./robotics-manipulator-kinematics/index.md)
- [휴머노이드 전신 역기구학과 동적 균형](./humanoid-balance-and-whole-body-ik/index.md)
