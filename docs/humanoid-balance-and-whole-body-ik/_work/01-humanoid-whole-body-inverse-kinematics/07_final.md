---
title: 휴머노이드 보행을 위한 전신 역기구학 기준 원고 확정
status: final
owner: agent
updated: 2026-09-22
target_reader: 1~4단계를 마친 로보틱스 입문자
topic: 접촉을 보존하는 휴머노이드 전신 역기구학
---
...
- 챕터 본문: `docs/humanoid-balance-and-whole-body-ik/01-humanoid-whole-body-inverse-kinematics.md`
- 책 진입점: `docs/humanoid-balance-and-whole-body-ik/index.md`
- 챕터 자산: `docs/humanoid-balance-and-whole-body-ik/assets/humanoid-whole-body-inverse-kinematics/`
