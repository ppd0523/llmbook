...
10. 운영 용어집
   - 가장 혼동하기 쉬운 용어 쌍 우선 비교
   - 상태, 도구, 지시, 실행, Kanban, model, security, Git, Claude Code 범주별 정의
   - 본문 첫 등장 정의를 보완하는 빠른 참조와 공식 출처
...
9장은 이 개념을 외부 coding agent를 운영하는 하나의 완결된 실습에 적용하고, 10장은
본문을 읽다가 낯선 말을 빠르게 되찾는 참조 장으로 사용한다.
