...
파일: Python 프로젝트 루트의 `flake.nix` (`devShells` 부분)
...
파일: Node.js 프로젝트 루트의 `.lazy.lua` (전체)
...
파일: Node.js 프로젝트 루트의 `flake.nix` (`shellHook` 부분)
...
파일: Rust 프로젝트 루트의 `rust-toolchain.toml` (전체)
